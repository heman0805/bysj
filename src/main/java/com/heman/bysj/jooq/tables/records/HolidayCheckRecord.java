...
public class HolidayCheckRecord extends UpdatableRecordImpl<HolidayCheckRecord> implements Record8<String, String, String, Integer, String, Integer, String, Timestamp> {

    private static final long serialVersionUID = 1802594032;
    ...
    @Override
    public Row8<String, String, String, Integer, String, Integer, String, Timestamp> valuesRow() {
    ...
    @Override
    public HolidayCheckRecord value6(Integer value) {
    ...
    @Override
    public HolidayCheckRecord values(String value1, String value2, String value3, Integer value4, String value5, Integer value6, String value7, Timestamp value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public HolidayCheckRecord(String checkid, String processinstanceid, String taskid, Integer userid, String role, Integer checkresult, String opinion, Timestamp checktime) {
        super(HolidayCheck.HOLIDAY_CHECK);
