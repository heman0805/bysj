...
public class ActHiTaskinst implements Serializable {
    ...
    private static final long serialVersionUID = -1640850764;
    ...
    public void setClaimTime_(Timestamp claimTime_) {
        this.claimTime_ = claimTime_;
    }
    ...
    public void setEndTime_(Timestamp endTime_) {
        this.endTime_ = endTime_;
    }
    ...
    public void setDueDate_(Timestamp dueDate_) {
        this.dueDate_ = dueDate_;
    }
